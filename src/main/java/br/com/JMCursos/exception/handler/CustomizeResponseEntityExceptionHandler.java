package br.com.JMCursos.exception.handler;
...
//Utilizar a anotação @ControllerAdvice para sinalizar que centraliza os erros comuns aqui, e extender a classe ResponseEntityExceptionHandler, onde as exceções mais comuns já estão
